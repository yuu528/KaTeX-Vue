import { defineComponent as da, ref as fa, onMounted as pa, watch as va, openBlock as ga, createElementBlock as ba } from "vue";
import './index.css';class u0 {
...
class O0 {
   ...
   */
  cramp() {
    return y0[Ra[this.id]];
  }
  /**
   * Get a text or display version of this style.
   */
  text() {
    return y0[Ia[this.id]];
  }
  /**
...
var dt = 0, Te = 1, _0 = 2, T0 = 3, le = 4, d0 = 5, ee = 6, n0 = 7, y0 = [new O0(dt, 0, !1), new O0(Te, 0, !0), new O0(_0, 1, !1), new O0(T0, 1, !0), new O0(le, 2, !1), new O0(d0, 2, !0), new O0(ee, 3, !1), new O0(n0, 3, !0)], Ca = [le, d0, le, d0, ee, n0, ee, n0], Na = [d0, d0, d0, d0, n0, n0, n0, n0], qa = [_0, T0, le, d0, ee, n0, ee, n0], Ea = [T0, T0, d0, d0, n0, n0, n0, n0], Ra = [Te, Te, T0, T0, d0, d0, n0, n0], Ia = [dt, Te, _0, T0, _0, T0, _0, T0], R = {
  DISPLAY: y0[dt],
  TEXT: y0[_0],
  SCRIPT: y0[le],
  SCRIPTSCRIPT: y0[ee]
...
var nt = {
  ...
  return typeof e != "string" && (e = e.unit), e in nt || e in Ka || e === "ex";
}, K = function(e, t) {
  var a;
  if (e.unit in nt)
...
class p0 {
  constructor(e, t, a, n, s, o, h, c) {
    ...
    var p = Oa(this.text.charCodeAt(0));
    p && this.classes.push(p + "_fallback"), /[îïíì]/.test(this.text) && (this.text = Qa[this.text]);
  }
  hasClass(e) {
    return q.contains(this.classes, e);
  }
...
for (var X0 = 0; X0 < 10; X0++) {
  var F0 = X0.toString();
  I = String.fromCharCode(55349, 57294 + X0), i(l, u, E, F0, I), i(k, u, v, F0, I), I = String.fromCharCode(55349, 57314 + X0), i(l, u, E, F0, I), i(k, u, v, F0, I), I = String.fromCharCode(55349, 57324 + X0), i(l, u, E, F0, I), i(k, u, v, F0, I), I = String.fromCharCode(55349, 57334 + X0), i(l, u, E, F0, I), i(k, u, v, F0, I);
}
var st = "ÐÞþ";
...
var ye = [
  ...
  if (s.charCodeAt(0) === 55349 && ([p, g] = r1(s, n)), p.length > 0)
  ...
  for (var e = 0; e < r.length - 1; e++) {
    var t = r[e], a = r[e + 1];
    t instanceof p0 && a instanceof p0 && s1(t, a) && (t.text += a.text, t.height = Math.max(t.height, a.height), t.depth = Math.max(t.depth, a.depth), t.italic = a.italic, r.splice(e + 1, 1), e--);
  }
  return r;
}, vt = function(e) {
  ...
  return vt(s), s;
}, kr = (r, e, t, a) => new he(r, e, t, a), o1 = function(e, t, a) {
  var n = l0([e], [], t);
  ...
  if (y < 0) {
    ...
    L = [l0(["vlist-r"], [V])];
  var X = l0(["vlist-t"], L);
  return L.length === 2 && X.classes.push("vlist-t2"), X.height = w, X.depth = -y, X;
}, d1 = (r, e) => {
...
var Ne = function(e) {
...
}, C0 = b.makeSpan, g1 = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"], b1 = ["rightmost", "mrel", "mclose", "mpunct"], y1 = {
  display: R.DISPLAY,
  text: R.TEXT,
  script: R.SCRIPT,
  ...
  if (e.length === 1) {
    var g = e[0];
    g.type === "sizing" ? p = t.havingSize(g.size) : g.type === "styling" && (p = t.havingStyle(y1[g.style]));
  }
  var y = C0([n[0] || "leftmost"], [], t), w = C0([n[1] || "rightmost"], [], t), x = a === "root";
  return Yt(s, (z, T) => {
    var C = T.classes[0], N = z.classes[0];
    C === "mbin" && q.contains(b1, N) ? T.classes[0] = "mord" : N === "mbin" && q.contains(g1, C) && (z.classes[0] = "mord");
  }, {
    node: y
  }, w, x), Yt(s, (z, T) => {
    var C = lt(T), N = lt(z), O = C && N ? z.hasClass("mtight") ? v1[C][N] : p1[C][N] : null;
    if (O)
...
var Dr = function(e) {
  ...
  var t = new S.MathNode("mo", [new S.TextNode(z1[e.replace(/^\\/, "")])]);
  ...
  function a() {
    ...
    if (q.contains(["widehat", "widecheck", "widetilde", "utilde"], c)) {
      ...
      var N = [], O = T1[c], [F, V, L] = O, U = L / 1e3, G = F.length, j, X;
      if (G === 1) {
        var M0 = O[3];
        j = ["hide-tail"], X = [M0];
      } else if (G === 2)
      ...
      for (var r0 = 0; r0 < G; r0++) {
        var e0 = new P0(F[r0]), U0 = new D0([e0], {
          ...
          height: A(U),
          viewBox: "0 0 " + h + " " + L,
          preserveAspectRatio: X[r0] + " slice"
...
var xt = (r, e) => {
  var t, a, n;
  r && r.type === "supsub" ? (a = H(r.base, "accent"), t = a.base, r.base = t, n = _a(P(r, e)), r.base = a) : (a = H(r, "accent"), t = a.base);
  ...
  var t = r.isStretchy ? N0.mathMLnode(r.label) : new S.MathNode("mo", [v0(r.label, r.mode)]), a = new S.MathNode("mover", [Y(r.base, e), t]);
  return a.setAttribute("accent", "true"), a;
}, N1 = new RegExp(["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring"].map((r) => "\\" + r).join("|"));
B({
  type: "accent",
  ...
  handler: (r, e) => {
    var t = Ne(e[0]), a = !N1.test(r.funcName), n = !a || r.funcName === "\\widehat" || r.funcName === "\\widetilde" || r.funcName === "\\widecheck";
    return {
      type: "accent",
      mode: r.parser.mode,
      label: r.funcName,
...
B({
  ...
  mathmlBuilder: (r, e) => {
    var t = N0.mathMLnode(r.label), a = new S.MathNode("munder", [Y(r.base, e), t]);
...
var E1 = {
  ...
  mode: "math",
  style: "display"
}), jt = (r) => r.type === "textord" && r.text === "@", R1 = (r, e) => (r.type === "mathord" || r.type === "atom") && r.text === e;
function I1(r, e, t) {
  var a = E1[r];
  switch (a) {
    case "\\\\cdrightarrow":
...
var ne = function(e, t, a) {
  ...
  var n = x0["Size4-Regular"][e.charCodeAt(0)] ? x0["Size4-Regular"][e.charCodeAt(0)][4] : x0["Size1-Regular"][e.charCodeAt(0)][4], s = new P0("inner", Ya(e, Math.round(1e3 * t))), o = new D0([s], {
    width: A(n),
    height: A(t),
    // Override CSS rule `.katex svg { width: 100% }`
    style: "width:" + A(n),
  ...
  var G = T + F + V, j = Math.max(0, Math.ceil((t - G) / (L * N))), X = G + j * L * N, M0 = n.fontMetrics().axisHeight;
  a && (M0 *= n.sizeMultiplier);
  var r0 = X / 2 - M0, e0 = [];
  if (y.length > 0) {
    var U0 = X - T - F, s0 = Math.round(X * 1e3), g0 = $a(y, Math.round(U0 * 1e3)), E0 = new P0(y, g0), W0 = (w / 1e3).toFixed(3) + "em", j0 = (s0 / 1e3).toFixed(3) + "em", Le = new D0([E0], {
      width: W0,
      height: j0,
      viewBox: "0 0 " + w + " " + s0
  ...
  var o = Xa(e, n, a), h = new P0(e, o), c = new D0([h], {
  ...
  var a = t.havingBaseSizing(), n = Xr("\\surd", e * a.sizeMultiplier, Ur, a), s = a.sizeMultiplier, o = Math.max(0, t.minRuleThickness - t.fontMetrics().sqrtRuleThickness), h, c = 0, p = 0, g = 0, y;
...
}, Gr = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "\\surd"], U1 = ["\\uparrow", "\\downarrow", "\\updownarrow", "\\Uparrow", "\\Downarrow", "\\Updownarrow", "|", "\\|", "\\vert", "\\Vert", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱"], Vr = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"], se = [0, 1.2, 1.8, 2.4, 3], X1 = function(e, t, a, n, s) {
  ...
  for (var s = Math.min(2, 3 - n.style.size), o = s; o < a.length && a[o].type !== "stack"; o++) {
    var h = ne(e, W1(a[o]), "math"), c = h.height + h.depth;
    if (a[o].type === "small") {
  ...
  var h;
  q.contains(Vr, e) ? h = Y1 : q.contains(Gr, e) ? h = Ur : h = $1;
  var c = Xr(e, t, h, n);
  return c.type === "small" ? H1(e, c.style, a, n, s, o) : c.type === "large" ? Lr(e, c.size, a, n, s, o) : Pr(e, t, a, n, s, o);
}, j1 = function(e, t, a, n, s, o) {
...
var kt = (r, e) => {
  ...
  if (a === "sout")
    ...
    var w = Math.floor(1e3 * y * n), x = Va(w), z = new D0([new P0("phase", x)], {
      width: "400em",
      height: A(w / 1e3),
...
var k0 = function(e, t) {
  ...
  for (V(o[0]), a = 0; a < e.body.length; ++a) {
    ...
    for (n = 0; n < L.length; ++n) {
      var X = P(L[n], t);
      G < X.depth && (G = X.depth), U < X.height && (U = X.height), j[n] = X;
    }
  ...
  if (e.cols && e.cols.length > 0) {
    ...
    for (var F = N; F < O; F++)
      z[F].type === "align" ? (x += K1[z[F].align], C && (T += "none "), C = !0) : z[F].type === "separator" && C && (T += z[F].separator === "|" ? "solid " : "dashed ", C = !1);
...
B({
  ...
  handler: (r, e) => {
    var {
      parser: t,
      funcName: a
    } = r, n = e[0], s = Ta(H(e[1], "infix").size), o = e[2], h = s.number > 0;
    return {
      type: "genfrac",
      mode: t.mode,
      numer: n,
...
var ur = (r) => r.body.replace(/ /g, r.star ? "␣" : " "), H0 = Ar, na = `[ \r
	]`, n4 = "\\\\[a-zA-Z@]+", i4 = "\\\\[^\uD800-\uDFFF]", s4 = "(" + n4 + ")" + na + "*", l4 = `\\\\(
|[ \r	]+
?)[ \r	]*`, mt = "[̀-ͯ]", o4 = new RegExp(mt + "+$"), u4 = "(" + na + "+)|" + // whitespace
(l4 + "|") + // \whitespace
"([!-\\[\\]-‧‪-퟿豈-￿]" + // single codepoint
(mt + "*") + // ...plus accents
"|[\uD800-\uDBFF][\uDC00-\uDFFF]" + // surrogate pair
...
class c4 {
  constructor(e, t, a) {
    this.settings = void 0, this.expansionCount = void 0, this.lexer = void 0, this.macros = void 0, this.stack = void 0, this.mode = void 0, this.settings = t, this.expansionCount = 0, this.feed(e), this.macros = new h4(m4, t.macros), this.mode = a, this.stack = [];
  }
  /**
...
class He {
  constructor(e, t) {
    this.mode = void 0, this.gullet = void 0, this.settings = void 0, this.leftrightDepth = void 0, this.nextToken = void 0, this.mode = "math", this.gullet = new c4(e, t, this.mode), this.settings = t, this.leftrightDepth = 0;
  }
  /**
...
const g4 = /* @__PURE__ */ da({
  ...
  setup(r) {
    ...
    function a() {
      v4.render(e.expr, t.value, {
        displayMode: !0,
        strict: !1,
        trust: !0
      });
    }
    return (n, s) => (ga(), ba("span", {
      ref_key: "target",
      ref: t
    }, null, 512));
  }
